...
After finishing the html of the page, I then used the prior organization to assign the colors and position given by the mock up.
...
**links**
  - Anchor tags were set to color #d62828 and then #f77f00 when they are hovered over. 

**Pete's profile picture**
  - The border-border radius property was set to 50%
  - The border property was set to 2 px solid #003049
  - All pictures were already centered.

The background was set to color #eae2b7 and headers and footers were centered. 
...
I referenced https://commonmark.org/help/ to make this README.md file. 
